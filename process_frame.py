...
class ProcessFrame:
    def __init__(self, thresholds, flip_frame = False):
        ...
        self.FEEDBACK_ID_MAP = {
                                0: ('Penchez-vous plus en arrière', 215, (0, 153, 255)),
                                1: ('Penchez-vous plus en avant', 215, (0, 153, 255)),
                                2: ('Reculez vos genoux', 170, (255, 80, 80)),
                                3: ('Descendez moins bas', 125, (255, 80, 80))
                               }
    ...
    def _get_state(self, knee_angle):#pour le nbr de rep
        ...
        if self.thresholds['HIP_KNEE_VERT']['NORMAL'][0] <= knee_angle <= self.thresholds['HIP_KNEE_VERT']['NORMAL'][1]: #si knee_angle est compris entre ['NORMAL'][0] et ['NORMAL'][1] alors on est à l'etat normal
            knee = 1
        elif self.thresholds['HIP_KNEE_VERT']['TRANS'][0] <= knee_angle <= self.thresholds['HIP_KNEE_VERT']['TRANS'][1]: #si knee_angle est compris entre ['TRANS'][0] et ['TRANS'][1] alors on est à l'etat TRANS
            knee = 2
        elif self.thresholds['HIP_KNEE_VERT']['PASS'][0] <= knee_angle <= self.thresholds['HIP_KNEE_VERT']['PASS'][1]: #si knee_angle est compris entre ['PASS'][0] et ['PASS'][1] alors on est à l'etat PASS
            knee = 3
